const pay = () => {
  ...
  form.addEventListener("submit", (e) => {
    ...
    const card = {
      number: formData.get("order_info[card_number]"),
      cvc: formData.get("order_info[card_cvc]"),
      exp_month: formData.get("order_info[card_exp_month]"),
      exp_year: `20${formData.get("order_info[card_exp_year]")}`,
    };
